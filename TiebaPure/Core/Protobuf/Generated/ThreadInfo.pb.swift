...
nonisolated extension Tieba_ThreadInfo: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{1}id\0\u{1}threadId\0\u{1}title\0\u{1}replyNum\0\u{1}viewNum\0\u{1}lastTime\0\u{1}lastTimeInt\0\u{1}threadTypes\0\u{1}isTop\0\u{1}isGood\0\u{2}\u{8}author\0\u{1}lastReplyer\0\u{1}commentNum\0\u{3}_abstract\0\u{1}media\0\u{2}\u{5}forumId\0\u{1}forumName\0\u{2}\u{a}isNoTitle\0\u{2}\u{2}firstPostId\0\u{2}\u{5}createTime\0\u{2}\u{5}collectStatus\0\u{1}collectMarkPid\0\u{3}post_id\0\u{2}\u{2}isMemberTop\0\u{2}\u{2}authorId\0\u{2}\u{5}pids\0\u{4}\u{b}twzhibo_info\0\u{2}\u{7}videoInfo\0\u{2} richTitle\0\u{1}richAbstract\0\u{3}ala_info\0\u{2}\u{7}dislikeInfo\0\u{2}\u{4}agreeNum\0\u{2}\u{2}agree\0\u{2}\u{9}shareNum\0\u{4}\u{6}origin_thread_info\0\u{1}firstPostContent\0\u{3}is_share_thread\0\u{2}\u{5}isTopic\0\u{1}topicUserName\0\u{1}topicH5Url\0\u{2}\u{5}forumInfo\0\u{2}\u{4}tShareImg\0\u{2}\u{5}nid\0\u{2}\u{b}tabId\0\u{1}tabName\0\u{2}\u{5}isDeleted\0\u{1}hotNum\0")
