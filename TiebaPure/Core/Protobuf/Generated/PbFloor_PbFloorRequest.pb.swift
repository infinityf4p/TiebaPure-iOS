...
nonisolated extension Tieba_PbFloor_PbFloorRequestData: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{1}kz\0\u{1}pid\0\u{1}spid\0\u{1}pn\0\u{3}scr_w\0\u{3}scr_h\0\u{3}scr_dip\0\u{2}\u{2}common\0\u{3}is_comm_reverse\0\u{3}forum_id\0\u{4}\u{4}ori_ugc_type\0")
